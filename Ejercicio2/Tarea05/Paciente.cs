...
//Class paciente con sus atributos 
class Paciente
{
    ...
    public double TiempoEsperaConsulta { get; set; } = 0;
    ...
    public void CambiarEstado(EstadoPaciente nuevoEstado)
    {
        ...
        if (nuevoEstado == EstadoPaciente.Consulta)
        {
            TiempoEsperaConsulta = RelojEstado.Elapsed.TotalSeconds;
        }
        Estado = nuevoEstado;
        RelojEstado.Restart();
    }
